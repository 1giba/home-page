        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
          ...
          <div class="mt-12 pt-8 border-t border-gray-200">
            <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 text-center">
              ...
              <router-link
                to="/contact"
                class="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-gradient-to-r from-purple-600 to-cyan-600 rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 hover:scale-105"
              >
                {{ t('home.cta') }}
                <svg
                  class="ml-2 h-4 w-4"
...
onMounted(() => {
  ...
  document.title = `${t('terms.title')} - Gabriel Alves`
})
</script>
